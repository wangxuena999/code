	...
	<form id="jvForm" action="articleupdate.do?id=${article.id }" method="post">
		<table cellspacing="1" cellpadding="2" width="100%" border="0" class="pn-ftable">
			<tbody id="tab_1">
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">创建时间:</td>
					<td width="80%" class="pn-fcontent">
						<input type="text"  name="crtime" maxlength="80"   class="Wdate" onclick="WdatePicker()" readonly="readonly" value="${article.crtime }"/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td width="80%" class="pn-fcontent">
						...
						<c:if test="${article.isremod==0 }">
								...
								<input type="radio" name="isremod" value="0" checked="checked" />不推荐
						</c:if>
					</td>
				</tr>
