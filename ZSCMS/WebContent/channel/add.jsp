		...
		<table cellspacing="1" cellpadding="2" width="100%" border="0" class="pn-ftable">
			<tbody id="tab_1">
					...
					<td width="80%" class="pn-fcontent">
						<select name="pid">
							<c:forEach items="${channelnames }" var="channelname">
								<option value="${channelname.id }" name="id">${channelname.channelpidname }</option>
							</c:forEach>
						</select>
				...
				<tr>
					...
					<td width="80%" class="pn-fcontent">
						<input type="radio" class="required" name="lev" maxlength="100" value="1" checked="checked"/>一级
						<input type="radio" class="required" name="lev" maxlength="100" value="2"/>二级
