...
<body>
	...
	<div class="body-box" style="float: right">
		<form id="jvForm" action="update.do?id=${CHANNEL.id }" method="post">
			<table cellspacing="1" cellpadding="2" width="100%" border="0"
				...
				<tbody id="tab_1">
					...
					<input type="hidden" name="lev" value="${CHANNEL.lev }" />
					<input type="hidden" name="isleaf" value="${CHANNEL.isleaf }" />
